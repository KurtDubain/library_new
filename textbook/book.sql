CREATE DATABASE  IF NOT EXISTS `textbook` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `textbook`;
...
CREATE TABLE `student` (
  ...
  FOREIGN KEY(`majorid`) REFERENCES majorlist(`id`),
  PRIMARY KEY (`id`),
...
CREATE TABLE `course` (
  ...
  PRIMARY KEY (`id`),
  FOREIGN KEY(`teacherid`) REFERENCES course(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
