                ...
                <div id="tab1" class="tabcontent">
                    ...
                    <form action="${url }" method="post" onsubmit="return checkform()">
                        ...
                        <div class="form">
                            ...
                            <div class="form_row">
                                <label>姓名:</label>
                                <input type="text" class="form_input" name="name"  id="name" value="${bean.name }"/>
                            </div>

                            <div class="form_row">
                                <label>学号:</label>
                                <input type="text" class="form_input" name="idcard"  id="idcard" value="${bean.idcard }"/>
                            </div>

                            <div class="form_row">
                                <label>手机:</label>
                                <input type="text" class="form_input" name="phone"  id="phone" value="${bean.phone }"/>
                            </div>
